...
<body>
  ...
  >
    <ul class="nav flex-column text-white w-100">
      ...
      <a href="yazokulu" class="nav-link">
        <i class="bx bxs-dashboard" style="color:hsl(7, 100%, 71%)"></i>
        <span class="mx-2">Yaz Okulu Başvurusu</span>
      </a>
      <a href="yataygecis" class="nav-link">
        <i class="iconify" data-icon="bx:bx-book-bookmark" style="color:hsl(7, 100%, 71%)"></i>
        <span class="mx-2">Yatay Geçiş Başvurusu</span>
      </a>
      <a href="dgsbasvuru" class="nav-link">
        <i class="iconify" data-icon="mdi:application" style="color:hsl(7, 100%, 71%)"></i>
        <span class="mx-2">DGS Başvurusu</span>
      </a>
      <a href="dersintibaki" class="nav-link">
        <i class="iconify" data-icon="carbon:application-web" style="color:hsl(7, 100%, 71%)"></i>
        <span class="mx-2">Ders İntibakı Başvurusu</span>
      </a>
      <a href="capbasvuru" class="nav-link">
        <i class="iconify" data-icon="mdi:application-edit-outline" style="color:hsl(7, 100%, 71%)"></i>
        <span class="mx-2">Çap Başvurusu</span>
      </a>
<style>
